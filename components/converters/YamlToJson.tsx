...
export function YamlToJson() {
  ...
  if (!input) {
    return <FileDropZone accept=".yaml,.yml" label="Upload a YAML file" description="Accepts .yaml or .yml files" onFile={handleFile} />;
  }
    ...
    <div className="space-y-4 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="space-y-2">
          <label className="text-sm font-medium text-zinc-600 dark:text-zinc-400">YAML Input</label>
